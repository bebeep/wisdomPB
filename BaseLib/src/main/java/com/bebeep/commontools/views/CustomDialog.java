    ...
    public static class Builder {
        ...
        public CustomDialog createSingleButtonDialog() {
            ...
            if (singleButtonText != null) {
                ...
                ((Button) layout.findViewById(R.id.singleButton)).setText(context.getString(R.string.btn_cancel));
            }
            create();
            return dialog;
        }
        ...
        public CustomDialog createTwoButtonDialog() {
            ...
            if (positiveButtonText != null) {
                ...
                ((Button) layout.findViewById(R.id.positiveButton)).setText(context.getString(R.string.btn_sure));
            }
            if (negativeButtonText != null) {
                ((Button) layout.findViewById(R.id.negativeButton)).setText(negativeButtonText);
            } else {
                ((Button) layout.findViewById(R.id.negativeButton)).setText(context.getString(R.string.btn_cancel));
            }
            create();
            return dialog;
        }
