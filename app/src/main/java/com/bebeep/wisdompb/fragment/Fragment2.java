        ...
        adapter = new CommonAdapter<String>(getActivity(),R.layout.item_f2,list){
            ...
            protected void convert(ViewHolder holder, String s, int position) {
                if(position%3 == 0) {
                    ...
                    holder.setBackgroundRes(R.id.tv_state, R.drawable.bg_rec_5dp_yellow);
                }else if(position%3 == 1) {
                    holder.setText(R.id.tv_state,"未开始");
                    holder.setBackgroundRes(R.id.tv_state, R.drawable.bg_rec_5dp_green);
                }else if(position%3 == 2) {
                    holder.setText(R.id.tv_state,"已过期");
                    holder.setBackgroundRes(R.id.tv_state, R.drawable.bg_rec_5dp_gray);
                }
